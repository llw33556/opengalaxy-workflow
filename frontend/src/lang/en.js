export default {
  route: {
    ...
    dbuserList: 'DBUser',
    dbtrxs:"DBTrxs",
    slowqueryreviewhistorys:"slowQuery",
    slowqueryreviewhistoryadds:"slowQueryToday",
    ...
    mk8s_harborlog: 'Log',
    mk8s_harbor_repo: 'Repo',
    mk8s_harbor_repo_tag: 'RepoDetail',
    mk8s_harbor_manifest: 'ManiFest',


    mk8s_conf_clusters: 'Cluster',
    mk8s_pub_deployments: 'Deploy',
    mk8s_pub_deployrecords: 'DeployRecord',
    mk8s_conf_labels: 'Label',
    mk8s_conf_resources: 'Resource',
    mk8s_conf_volumes: 'Volume',
    mk8s_pub:'Pub',
    mk8s_conf:'Conf',

    mk8s_cluster: "K8sClusterManage",
    mk8s_pod: "AppInstance",
    mk8s_deployment: "AppControl",
    mk8s_event: "ClusterEvent",
    mk8s_node: "ClusterNode",

    iapetus:"iapetus",
    chains:"BusChain",
    chainnodes:'BusLocateMap',
